...
pub use crate::shielded_notes::{
    ...
    prove_shielded_transfer, prove_shielded_withdraw, shielded_command_binding_hex,
    ...
    shielded_withdraw_public_inputs_hex, ShieldedActionFixture, ShieldedCircuitBundle,
    ShieldedCommandActionFixture, ShieldedCommandFixture, ShieldedCommandProofResult,
    ShieldedCommandProverBundle, ShieldedCommandRequest, ShieldedDepositRequest, ShieldedFixture,
    ShieldedInputRequest, ShieldedOutputRequest, ShieldedProofResult, ShieldedProverBundle,
