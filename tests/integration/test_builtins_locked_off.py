...
class TestBuiltinsLockedOff(TestCase):
    ...
    def test_if_builtin_can_be_submitted(self):
        builtin_path = os.path.join(
            os.path.dirname(__file__), "test_contracts", "builtin_lib.s.py"
        )
...
class TestMathBuiltinsLockedOff(TestCase):
    ...
    def test_if_builtin_can_be_submitted(self):
        mathtime_path = os.path.join(
            os.path.dirname(__file__), "test_contracts", "mathtime.s.py"
        )
...
class TestContractModuleLoaderLoadsFirst(TestCase):
    def setUp(self):
        self.c = ContractingClient(signer="stu")
    ...
    def test_if_builtin_can_be_submitted(self):
        contracting_path = os.path.join(
            os.path.dirname(__file__), "test_contracts", "contracting.s.py"
        )
        ...
        import_test_path = os.path.join(
            os.path.dirname(__file__), "test_contracts", "import_test.s.py"
        )
...
class TestDynamicImport(TestCase):
    ...
    def test_if_builtin_can_be_submitted(self):
        dynamic_import_path = os.path.join(
            os.path.dirname(__file__), "test_contracts", "dynamic_import.s.py"
        )
...
class TestFloatIssue(TestCase):
    ...
    def test_if_builtin_can_be_submitted(self):
        float_issue_path = os.path.join(
            os.path.dirname(__file__), "test_contracts", "float_issue.s.py"
        )
